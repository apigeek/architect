...
var Runner = require("./daemon/LocalRunner");

// setup ApiGeek

cli.version(pkg.version);

var apigeek = new ApiGeek();
...
app.get("/test/:suite", new Runner(apigeek));

// start listening
app.listen(PORT, function() { console.log('%s on port %s', pkg.name, PORT)});
